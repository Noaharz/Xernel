...
pub use self::x86_64::{
    ...
    keyboard_selftest, map_user, paging_selftest, pci_config_read, serial_write, set_kernel_stack,
    switch_context, timer_ticks, usable_regions, vspace_alloc_map, vspace_current, vspace_map,
    vspace_new, vspace_selftest, vspace_switch,
};
#[cfg(target_arch = "x86_64")]
